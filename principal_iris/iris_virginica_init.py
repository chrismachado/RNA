...
def main():
    ...
    # plot_decision(X=X_new[imin_][1], y=y_new[imin_][1], clf=ppn, title="Superficie de decisao [%d]   Virginica x Outras" % (imin_ + 1),
    ...
    # plot_decision(X=X_new[imax_][1], y=y_new[imax_][1], clf=ppn, title="Superficie de decisao [%d]   Virginica x Outras" % (imax_ + 1),
    #               xlabel="Comprimento Sépala", ylabel="Largura Sépala")
    ...
    #               title="Superficie de decisao [%d]  Virginica x Outras" % (imax_ + 1),
    #               xlabel="Comprimento Sépala", ylabel="Largura Sépala")
