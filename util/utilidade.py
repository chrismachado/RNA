...
def execution(X, y, clf, num=20):
    ...
    imax_, imin_ = evaluate_exec(accuracy=accuracy)

    inf_log(accuracy, dmm, weights, imax_, imin_)

    return X_new, y_new, accuracy, weights, dmm, erros, imax_, imin_


def plot_decision(X, y, clf, title='Title', xlabel='xlabel', ylabel='ylabel'):
...
def plot_learning_bend(erros, title='Title', xlabel='xlabel', ylabel='ylabel'):
...
def inf_log(accuracy, dmm, weights, imax_, imin_):
    print("+=================================================+")
